...
<template>
    <div class="flex min-h-screen bg-slate-100">
        <!-- Sidebar -->
        <aside :class="[
            'sideBarColor absolute inset-y-0 left-0 z-20 flex flex-col transition-all duration-300 rounded-tr-[15%] rounded-br-[15%]',
        ...
        <div class="w-full flex flex-col">
            ...
            <nav
                ...
                <div class="w-full ml-[12%] flex justify-between items-center toggleNav">
                    <div class="flex items-center gap-4 ">
                        <span class="md:text-lg font-semibold text-sm ml-4 ">HRM Tenant Dashboard</span>
                    </div>
