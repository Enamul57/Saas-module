                ...
                <form @submit.prevent="submitForm" class="bg-white rounded-xl p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <span v-if="form.errors.middle_name" class="text-red-500 text-sm">{{ form.errors.middle_name
                                }}</span>
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-gray-700 font-medium mb-1">Passport Number (if applicable)</label>
                    ...
                    <div>
                        ...
                        <input type="file" ref="attachmentInput" multiple @change="previewAttachments" class="hidden"
                            ...
                            <div v-if="props.employee?.personal_details?.attachments?.length"
                                ...
                                <div v-for="(file, index) in props.employee.personal_details.attachments"
                                    ...
                                    <img v-if="isImage(file.file_name)" :src="file.file_path"
                                        class="w-12 h-12 object-cover rounded-md border" alt="Existing attachment" />
                                    <!-- File icon otherwise -->
                                    <div v-else
